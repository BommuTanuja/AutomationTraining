...
public class VerifyErrorMessages {
    ...
    public void verifyErrorMessages(){
        ...
        System.out.println(getErrorMessage("Employees"));
        ...
        List<String > expectedErrorMessage = Arrays.asList("Enter your first name","Enter your last name","Enter a valid email address","Select your title","Enter your company name","Select the number of employees","Enter a valid phone number");
        ...
        Assert.assertEquals(actualErrorMessages,expectedErrorMessage);
    }
